            ...
            <ScrollReveal direction="left">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-muca-dark">{t.contact.address}</h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-muca-dark">{t.contact.phone}</h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-muca-dark">{t.contact.instagram}</h3>
                    <a
              ...
              <div className="mt-10 relative h-80 overflow-hidden rounded-2xl shadow-lg">
                <Image
                  src={`${basePath}/images/storefront.jpg`}
