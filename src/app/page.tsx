...
const reviews = [
  {
    name: "Mehmet A.",
    rating: 5,
    text: "Bester Döner in Kreuzberg! Das Hausbrot ist unglaublich frisch und das Fleisch saftig. Absolute Empfehlung!",
    timeAgo: "vor 2 Wochen",
  },
  {
    name: "Sarah L.",
    rating: 5,
    text: "Endlich ein Döner-Laden, der wirklich auf Qualität setzt. Man schmeckt, dass alles frisch zubereitet wird. Top!",
    timeAgo: "vor 1 Monat",
  },
  {
    name: "Thomas K.",
    rating: 5,
    text: "Super freundliches Personal und das Essen ist einfach hervorragend. Das hausgemachte Brot macht den Unterschied!",
    timeAgo: "vor 3 Wochen",
  },
  {
    name: "Ayse D.",
    rating: 5,
    text: "Halal und frisch - genau was ich gesucht habe. Die Portionen sind großzügig und der Geschmack unschlagbar.",
    timeAgo: "vor 1 Woche",
  },
  {
    name: "Daniel R.",
    rating: 5,
    text: "Bin extra aus Mitte hierher gefahren und es hat sich absolut gelohnt. Der Döner ist der Hammer!",
    timeAgo: "vor 2 Monaten",
  },
  {
    name: "Fatma Y.",
    rating: 5,
    text: "Sauber, lecker und freundlich. Was will man mehr? Komme jede Woche hierher. Mein Lieblingsimbiss in Berlin!",
    timeAgo: "vor 3 Wochen",
  },
  {
    name: "Marco P.",
    rating: 5,
    text: "Ich war skeptisch, aber nach dem ersten Biss war ich überzeugt. Frisches Fleisch, knuspriges Brot - perfekt!",
    timeAgo: "vor 1 Monat",
  },
  {
    name: "Leila B.",
    rating: 5,
    text: "Das Beste am Oranienplatz! Alles wird vor deinen Augen frisch zubereitet. Hygiene ist hier wirklich top.",
    timeAgo: "vor 2 Wochen",
  },
  {
    name: "Stefan H.",
    rating: 5,
    text: "Habe viele Döner in Berlin probiert, aber Muca ist wirklich etwas Besonderes. Das Hausbrot ist ein Traum!",
    timeAgo: "vor 1 Woche",
  },
];
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <StaggerReveal className="grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <div className="text-center p-8 rounded-2xl bg-white shadow-sm">
              ...
              <h3 className="text-xl font-bold text-muca-dark mb-2">Einwandfreie Hygiene</h3>
              <p className="text-gray-600">
                Sauberkeit ist für uns selbstverständlich. Wir setzen höchste Hygienestandards für Ihre Sicherheit.
              </p>
            </div>
          </StaggerReveal>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <div className="text-center mb-12">
              ...
              <p className="text-gray-500">5.0 Sterne basierend auf Google-Bewertungen</p>
            </div>
          </ScrollReveal>
